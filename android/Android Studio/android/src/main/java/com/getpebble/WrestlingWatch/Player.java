...
public class Player {
    ...
    public Player(Context context, TextView nameText, TextView scoreText, String name) {
        this.name = name;
    ...
    public void openNewPointsViewDialog() {
        ...
        Map<String, String> textMap = getPointsAsString(points);
        ...
        periodText.setTextColor(Color.BLUE);
        ...
        pointText.setTextColor(Color.BLUE);
    ...
    private Map<String,String> getPointsAsString(List<Point> points) {
